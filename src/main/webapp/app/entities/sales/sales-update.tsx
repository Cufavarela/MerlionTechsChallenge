        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="compradorLabel" for="sales-comprador">
                  <Translate contentKey="testApp.sales.comprador">Comprador</Translate>
                </Label>
                <AvField id="sales-comprador" type="text" name="comprador" />
              </AvGroup>
              <AvGroup>
                <Label id="fechaLabel" for="sales-fecha">
                  <Translate contentKey="testApp.sales.fecha">Fecha</Translate>
                </Label>
                <AvField id="sales-fecha" type="text" name="fecha" />
              </AvGroup>
              <AvGroup>
                <Label id="pagadoLabel" for="sales-pagado">
                  <Translate contentKey="testApp.sales.pagado">Pagado</Translate>
                </Label>
                <AvField id="sales-pagado" type="text" name="pagado" />
              </AvGroup>
              <AvGroup>
                <Label id="precioLabel" for="sales-precio">
                  <Translate contentKey="testApp.sales.precio">Precio</Translate>
                </Label>
                <AvField id="sales-precio" type="text" name="precio" />
              </AvGroup>
              <AvGroup>
